...
TEST(test_network, resnet1) {
  using namespace kuiper_infer;
  const std::string &param_path = "/home/kuiperdatawhale/course8/model_file/resnet18_batch1.pnnx.param";
  const std::string &weight_path = "/home/kuiperdatawhale/course8/model_file/resnet18_batch1.pnnx.bin";
  RuntimeGraph graph(param_path, weight_path);
  graph.Build("pnnx_input_0", "pnnx_output_0");

  const uint32_t batch_size = 1;
  std::vector<sftensor> inputs;
  const std::string &path("/home/kuiperdatawhale/course8/model_file/car.jpg");
